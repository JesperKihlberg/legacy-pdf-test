...
(function pdfViewerWrapper() {
  ...
  function getScrollContainer(rootContainer) {
    var scrollContainer = rootContainer;
    while (
      scrollContainer != null &&
      scrollContainer.scrollTop + scrollContainer.scrollLeft <= 0
    ) {
      scrollContainer = scrollContainer.parentNode;
      // Fixed null reference exception when parentNode is null (happened in storybook when orphaned pdf viewer get scroll events)
      // This also happens because this version has memory leaks, since there are no "dispose"/cleanup methods that
      // detaches from eventlisteners, meaning that PdfViewer are pilling up and keep handling events
      // Check US 79412 for upgrading pdfjs-dist which hopefully has improved this in later versions
      if (!scrollContainer || typeof scrollContainer.scrollTop == "undefined") {
        scrollContainer = null;
      }
    }
    return scrollContainer == null ? rootContainer : scrollContainer;
  }
  ...
  function getVisibleElements(scrollEl, views, sortByVisibility) {
    var scrollableContainer = getScrollContainer(scrollEl);
    var top = scrollableContainer.scrollTop,
      bottom = top + scrollEl.clientHeight;
    var left = scrollableContainer.scrollLeft,
    ...
    PDFPageView.prototype = {
      ...
      draw: function PDFPageView_draw() {
        ...
        if (
          this.annotationLayer &&
          this.annotationLayer.div &&
          this.annotationLayer.div.parentNode == div
        ) {
        ...
        if (this.annotationsLayerFactory) {
          if (!this.annotationLayer) {
            this.annotationLayer = this.annotationsLayerFactory.createAnnotationsLayerBuilder(
              div,
              this.pdfPage
            );
          }
  ...
  var TextLayerBuilder = (function TextLayerBuilderClosure() {
    ...
    TextLayerBuilder.prototype = {
      ...
      convertMatches: function TextLayerBuilder_convertMatches(matches) {
        ...
        var queryLen =
          this.findController === null || this.findController.state === null
            ? 0
  ...
  var PDFViewer = (function pdfViewer() {
    ...
    function PDFViewer(options) {
      ...
      this.annotationsLayerFactory = options.annotationsLayerFactory || this;
    ...
    PDFViewer.prototype = /** @lends PDFViewer.prototype */ {
          ...
          function(pdfPage) {
            ...
            for (var pageNum = 1; pageNum <= pagesCount; ++pageNum) {
              ...
              var pageView = new PDFPageView({
                ...
                annotationsLayerFactory: this.annotationsLayerFactory
              });
      ...
      _updateLocation: function(firstPage) {
        ...
        var container = getScrollContainer(this.container);
      ...
      get isHorizontalScrollbarEnabled() {
        return this.isInPresentationMode
          ? false
          : getScrollContainer(this.container).scrollWidth >
              getScrollContainer(this.container).clientWidth;
      },
